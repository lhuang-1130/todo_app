...
//create a globally accessible array to store todo and completed tasks
...
// load the previous todo list
renderTodoList();

// user can add a task by clicking on the add button 
document.getElementById('add').addEventListener('click', function() {
    var value = document.getElementById('item').value;

    //if there is a value, we add it to the todo list
    if (value){
        addItem(value);
    }   
});

// user can add a task by hitting an enter key
...
function doneItem(){
    ...
    dataObjectUpdated();
    //check if the item should be added to complted to re-added to the to-do list
...
function addTodo(task, completed){
    //if completed is true, add to the completed list
    //else, add to the todo list
